...
<head>
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Submit' == $_POST["btnSubmit"]) {
      ...
      $stmt = "Insert into typeofleave(LeaveType,Flag)values('" . $LeaveType . "','" . $Flag . "') ";
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Update' == $_POST["btnSubmit"]) {
      $LeaveType = $_POST['LeaveType'];
      $stmt = "Update typeofleave set LeaveType='" . $LeaveType . "' where TypeOfLeaveID=" . $_GET['TypeOfLeaveID'];
      if ($conn->query($stmt) === true) {
  ...
  if (empty($_GET['TypeOfLeaveID'])) {
    ...
    $btn = "Update";
    $stmt = "Select * from typeofleave where TypeOfLeaveID=" . $_GET['TypeOfLeaveID'];
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo $LeaveType; ?>" name="LeaveType" maxlength="50"
