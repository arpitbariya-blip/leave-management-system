...
class Mysqldump
{
    ...
    public function __construct(
        ...
        $user = '',
        $pass = '',
        $dumpSettings = array(), $pdoSettings = array())
    {
...
class TypeAdapterMysql extends TypeAdapterFactory
{
    ...
    public function create_trigger($row)
    {
        ...
        if (
            $triggerStmtReplaced = preg_replace(
    ...
    public function create_procedure($row)
    {
        ...
        if ($this->dumpSettings['skip-definer']) {
            if (
                $procedureStmtReplaced = preg_replace(
    ...
    public function create_function($row)
    {
        ...
        if ($this->dumpSettings['skip-definer']) {
            if (
                $functionStmtReplaced = preg_replace(
    ...
    public function create_event($row)
    {
        ...
        if (
            $eventStmtReplaced = preg_replace(
