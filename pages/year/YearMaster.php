...
<head>
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Submit' == $_POST["btnSubmit"]) {
      ...
      $stmt = $conn->prepare("INSERT INTO yearmaster (Year, Flag) VALUES (?, ?)");
      $stmt->bind_param("si", $Year, $Flag);
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Update' == $_POST["btnSubmit"]) {
      ...
      $stmt->bind_param("si", $Year, $_GET['YearID']);
    ...
    <div class="container" style="color:black;">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <input type="text" class="form-control" value="<?php echo htmlspecialchars($Year, ENT_QUOTES, 'UTF-8'); ?>" name="Year" maxlength="4" id="Year"
            placeholder="Year">
