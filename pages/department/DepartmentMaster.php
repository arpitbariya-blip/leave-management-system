...
<head>
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Submit' == $_POST["btnSubmit"]) {
      ...
      $stmt = $conn->prepare("INSERT INTO departmentmaster (DeptName, Flag) VALUES (?, ?)");
      $stmt->bind_param("si", $DeptName, $Flag);
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Update' == $_POST["btnSubmit"]) {
      ...
      $DeptName = $_POST['DeptName'];
      $stmt = $conn->prepare("UPDATE departmentmaster SET DeptName=? WHERE DeptID=?");
      $stmt->bind_param("si", $DeptName, $_GET['DeptID']);
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($DeptName, ENT_QUOTES, 'UTF-8'); ?>" name="DeptName" maxlength="50"
