...
<head>
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Submit' == $_POST["btnSubmit"]) {
      ...
      $stmt = $conn->prepare("INSERT INTO facultyinfo (FacultyName, ContactNo, JoiningDate, RelievingDate, Designation, DeptID) VALUES (?, ?, ?, ?, ?, ?)");
      $stmt->bind_param("ssssss", $FacultyName, $ContactNo, $JoiningDate, $RelievingDate, $Designation, $DeptName);
  ...
  if (isset($_POST["btnSubmit"])) {
    if ('Update' == $_POST["btnSubmit"]) {
      ...
      $stmt = $conn->prepare("UPDATE facultyinfo SET FacultyName=?, ContactNo=?, JoiningDate=?, RelievingDate=?, Designation=?, DeptID=? WHERE FacultyInfoID=?");
      $stmt->bind_param("ssssssi", $FacultyName, $ContactNo, $JoiningDate, $RelievingDate, $Designation, $DeptName, $_GET["FacultyInfoID"]);
  ...
  if (empty($_GET["FacultyInfoID"])) {
    ...
    $btn = "Update";
    $stmt = $conn->prepare("SELECT * FROM facultyinfo WHERE FacultyInfoID=?");
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="FacultyName" value="<?php echo htmlspecialchars($FacultyName, ENT_QUOTES, 'UTF-8'); ?>"
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="ContactNo" value="<?php echo htmlspecialchars($ContactNo, ENT_QUOTES, 'UTF-8'); ?>" maxlength="10"
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="date" class="form-control" value="<?php echo htmlspecialchars($JoiningDate, ENT_QUOTES, 'UTF-8'); ?>" name="JoiningDate" maxlength="8"
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="date" class="form-control" value="<?php echo htmlspecialchars($RelievingDate, ENT_QUOTES, 'UTF-8'); ?>" name="RelievingDate"
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($Designation, ENT_QUOTES, 'UTF-8'); ?>" required="" name="Designation"
