...
<html lang="en">
    ...
    <?php 
      ...
      if(isset($_POST["btnSubmit"]))
      {
        ...
        else
        {
            ...
            if (empty($filename)) { $filename = time() . ".jpg"; } else { $filename .= ".jpg"; }
            $tempname = $_FILES["StudPhoto"]["tmp_name"];    
            $folder = "ProfilePic/".$filename;
            
            $stmt = $conn->prepare("INSERT INTO studregistration (EnrollmentNo,profile,FirstName,MiddleName,LastName,Gender,Category,DOB,AdharcardNo,PH,Minority,MobileNo,ParentsMobileNo,EmailId,Address,DepartmentName,AdmittedYear,Semester,TFW,Shift,RecordCreated,ipadd) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $stmt->bind_param("ssssssssssssssssssssss", $EnrollNo, $filename, $FirstName, $MiddleName, $LastName, $Gender, $category, $dob, $acno, $ph, $minor, $smobile, $pmobile, $email, $address, $department, $admittedyear, $semester, $tfw, $shift, $date, $ip);
  ...
  <body>
    ...
    <?php
        ...
        {
        $stmt = $conn->prepare("SELECT * FROM studregistration WHERE StudRegID=?");
        $stmt->bind_param("i", $_GET['StudRegID']);
        $stmt->execute();
       ...
       <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="EnrollmentNo" value= "<?php echo htmlspecialchars($EnrollNo, ENT_QUOTES, 'UTF-8'); ?>" onkeypress="return isNumber(event);" maxlength="12" id="EnrollmentNo"  placeholder="Enrollment No">
                </div>
            </div>
            <div class="col-sm-6">
                <label for="formFile" class="form-label">Upload your photo<sup style="color:red; font-size: 15px";>*</sup> :</label>
                <input class="form-control" type="file" value= "<?php echo htmlspecialchars($filename, ENT_QUOTES, 'UTF-8'); ?>" name="StudPhoto" id="StudPhoto" onchange="loadFile(event)" accept=".jpg,.png,.gif" required=""><?php echo htmlspecialchars($filename, ENT_QUOTES, 'UTF-8'); ?></input>
                
            </div>
            <div class="col-sm-2">
                <img  src="<?php echo htmlspecialchars($filename, ENT_QUOTES, 'UTF-8'); ?>" id= "output" width="100px" height="200px" class="img-thumbnail" >
            </div>
         </div>
        ...
        <div class="row">
            <div class="col-sm">
                <div class="form-group">
                     ...
                     <input type="text" class="form-control" value= "<?php echo htmlspecialchars($FirstName, ENT_QUOTES, 'UTF-8'); ?>" name="FirstName" id="FirstName" placeholder="First Name" required="">
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                     <label for="Mname">Middle Name :</label>
                     <input type="text" class="form-control" value= "<?php echo htmlspecialchars($MiddleName, ENT_QUOTES, 'UTF-8'); ?>" name="MiddleName" id="MiddleName" placeholder="Father Name" >
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                     <label for="Sname">Surname Name<sup style="color:red; font-size: 15px";>*</sup>:</label>
                     <input type="text" class="form-control" value= "<?php echo htmlspecialchars($LastName, ENT_QUOTES, 'UTF-8'); ?>" name="LastName" id="FirstName" placeholder="Surname Name" required="">
                </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="col-sm">
                <div class="form-group">
                     ...
                     <input type="text" name="acno" maxlength="12" value= "<?php echo htmlspecialchars($acno, ENT_QUOTES, 'UTF-8'); ?>" onkeypress="return isNumber(event);" class="form-control" id="acno" placeholder="Adarcard No">
                </div>
            </div>
            <div class="col-sm">
         ...
         <div class="row">
            <div class="col-sm">
                <div class="form-group">
                     ...
                     <input type="text" name="smobile" value= "<?php echo htmlspecialchars($smobile, ENT_QUOTES, 'UTF-8'); ?>" maxlength="10" onkeypress="return isNumber(event);" class="form-control" id="smobile" placeholder="Studnet Mobile" required="" >
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                     <label for="pmobile">Parents Mobile No<sup style="color:red; font-size: 15px";>*</sup>:</label>
                     <input type="text" name="pmobile" maxlength="10" value= "<?php echo htmlspecialchars($pmobile, ENT_QUOTES, 'UTF-8'); ?>" onkeypress="return isNumber(event);" class="form-control" id="pmobile" placeholder="Parents Mobile" required="">
                </div>
            </div>
            <div class="col-sm">
                <div class="form-group">
                     <label for="Email">Email Id :</label>
                     <input type="email" name="email" value= "<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>" class="form-control" id="email" placeholder="name@example.com">
                </div>
            </div>
         </div>
         <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                     ...
                     <textarea class="form-control" name="address" id="address" rows="3" required=""><?php echo htmlspecialchars($address, ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
            </div>
         </div>
