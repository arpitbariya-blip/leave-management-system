            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?php
            if (isset($_SESSION['UserType']) && $_SESSION['UserType'] == 'Department User') {

                            $stmt = $conn->prepare("SELECT * FROM departmentmaster WHERE DeptID=?");
                ...
                <select id="S1" name="DeptName" required="" class="form-control" value=" <?php echo $DeptID; ?>">
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ...
                        if (isset($_SESSION['DeptID']) && $data[0] == $_SESSION['DeptID'] || (isset($DeptID) && $data[0] == $DeptID)) {
